...
```
mysql -h expense-dev.clisaqck6df9.us-east-1.rds.amazonaws.com -u root -pExpenseApp1
```
```
USE transactions;
```
...
--attach-policy-arn=arn:aws:iam::339713002272:policy/AWSLoadBalancerControllerIAMPolicy \
